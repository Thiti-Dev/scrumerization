...
type roomsTable struct {
	...
	RoomName  postgres.ColumnString
...
func newRoomsTableImpl(schemaName, tableName, alias string) roomsTable {
	var (
		...
		RoomNameColumn  = postgres.StringColumn("room_name")
		PasswordColumn  = postgres.StringColumn("password")
		IsActiveColumn  = postgres.BoolColumn("is_active")
		CreatedAtColumn = postgres.TimestampzColumn("created_at")
		UpdatedAtColumn = postgres.TimestampzColumn("updated_at")
		allColumns      = postgres.ColumnList{IDColumn, CreatorIDColumn, RoomNameColumn, PasswordColumn, IsActiveColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns  = postgres.ColumnList{CreatorIDColumn, RoomNameColumn, PasswordColumn, IsActiveColumn, CreatedAtColumn, UpdatedAtColumn}
	)
