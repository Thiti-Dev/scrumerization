<template>
    <div>
        <section class="bg-gray-50 dark:bg-gray-900 font-workbench">
                ...
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <form @submit.prevent="submitForm" class="space-y-4 md:space-y-6" action="#">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Doesn't have accoint? <a href="/registration" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Register here</a>
                        </p>
                    </form>
                </div>
            </div>
